...
function twentyseventeen_scripts() {
	...
	wp_enqueue_script( 'customJS', get_theme_file_uri( '/assets/js/common.js' ), array( 'jquery' ), '1.0', true );
...
function wps_add_extra_product_thumbs() {
    ...
    if ( is_shop() ) {
        ...
        echo '<div class="product-item_carousel">';
...
add_action('init','remove_woocommerce_actions',10);
